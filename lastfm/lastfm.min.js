...
null!=b.artist["#text"]?b.artist["#text"]:"unknown artist",h=null!=b.date&&null!=b.date.uts?d.relativeTime(b.date.uts):"",w=null!=b["@attr"]&&null!=b["@attr"].nowplaying?'<img src="http://'+k+'/js/lastfm/eq.gif" alt="\u518d\u751f\u4e2d" width="12" height="12" /> \u518d\u751f\u4e2d':"",x=null!=b.date&&null!=b.date.uts?b.date.uts:parseInt((new Date).getTime()/1E3),n=p.length;p[n]=[g,f];a.append('<div id="atrack-'+n+'" style="clear:both;"><div class="ctime" data-datetime="'+x+'">'+w+h+'</div><a href="'+
...
eachThis:function(a){e("#more_track").empty().append('<div style="text-align:right;"><img src="http://'+k+'/js/lastfm/indi.gif" alt="\u8aad\u307f\u8fbc\u307f\u4e2d..." width="10" height="10" /> \u8aad\u307f\u8fbc\u307f\u4e2d...</div>');var b=m;if(1<=b&&h.length>=c.page_count){a.append('<div class="track" style="opacity:0.0;" />');var v=a.children(".track:last");d.shiftItems(v)}else return e.ajax({url:"http://ws.audioscrobbler.com/2.0/",data:{method:"user.getrecenttracks",user:c.username,api_key:c.apikey,
