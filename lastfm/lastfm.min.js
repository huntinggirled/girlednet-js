...
g.append('<a href="'+decodeURIComponent(e)+'" title="'+c+'" target="_blank"><img src="'+f+'" class="widget-img-thumb" alt="'+c+'" /></a>')})}},a=e(this);a.children(".ainfo").empty().append('<img src="http://'+k+'/js/lastfm/indi.gif" alt="\u5546\u54c1\u691c\u7d22\u4e2d..." width="10" height="10" /> \u5546\u54c1\u691c\u7d22\u4e2d...');e.ajax({url:"http://"+k+"/js/lastfm/amazon/request.php",data:{search_index:"Music",artist:p[d][0],title:p[d][1],item_page:c},dataType:"jsonp",callback:"callback",timeout:5E3}).done(function(b,
