...
l+'" title="'+g+" - "+f+'" target="_blank"><img src="'+c+'" class="widget-img-thumb" alt="'+g+" - "+f+'" onerror="this.src=(\'http://'+k+'/js/lastfm/noartwork.gif\')" /></a><a href="'+l+'" title="'+g+" - "+f+'" target="_blank">'+(32<f.length?f.slice(0,32)+"...":f)+'</a><br /><a href="'+l+'" title="'+g+" - "+f+'" target="_blank">'+(32<g.length?g.slice(0,32)+"...":g)+'</a><div class="alist" style="clear:both;"></div><div class="ainfo" style="text-align:right;clear:both;opacity:0.2;"><a href="" onclick="$(this).closest(\'#atrack-'+
n+"').productSearch("+n+', 1);return false;">[Amazon\u3067\u691c\u7d22]</a></div></div>');a.children("#atrack-"+n).hover(function(){e(this).children(".ainfo").fadeTo("normal",1)},function(){e(this).children(".ainfo").fadeTo("normal",0.2)});a.fadeTo("normal",1)},shiftItems:function(a){for(var b=0;b<c.page_count&&!(d.printContent(a,h.shift()),0>=h.length);b++);d.elapsedTime(r);e("#more_track").empty().append('<div style="text-align:right;"><a href="" onmouseover="$(\'#lastfm\').getRecentTracks();return false;">[\u3055\u3089\u306b\u8aad\u307f\u8fbc\u3080]</a></div>')},
eachThis:function(a){e("#more_track").empty().append('<div style="text-align:right;"><img src="http://'+k+'/indi.gif" alt="\u8aad\u307f\u8fbc\u307f\u4e2d..." width="10" height="10" /> \u8aad\u307f\u8fbc\u307f\u4e2d...</div>');var b=m;if(1<=b&&h.length>=c.page_count){a.append('<div class="track" style="opacity:0.0;" />');var u=a.children(".track:last");d.shiftItems(u)}else return e.ajax({url:"http://ws.audioscrobbler.com/2.0/",data:{method:"user.getrecenttracks",user:c.username,api_key:c.apikey,limit:0==
m?c.default_count:c.limit,page:0==m?1:b,format:"json"},dataType:"jsonp",callback:"callback",timeout:5E3}).done(function(l,f){if(null==l||null==l.recenttracks)return e("#more_track").empty(),!1;if(0==b||1==b)h=[];h=h.concat(l.recenttracks.track);1==b&&h.splice(0,c.default_count);0==b&&a.empty();a.append('<div class="track" style="opacity:0.0;" />');var g=a.children(".track:last");d.shiftItems(g);m++}).fail(function(b,c,g){d.elapsedTime(a);e("#more_track").empty()}).always(function(b,a){})}},r=e(this);
d.eachThis(r);var t=(new Date).getTime();null!=q&&clearInterval(q);q=setInterval(function(){t+c.reload<(new Date).getTime()&&(m=0,d.eachThis(r),t=(new Date).getTime())},c.interval)};e.fn.productSearch=function(d,c){var h={productSearchComplete:function(b,a,c){var f=100<=b.result.TotalResults?100:b.result.TotalResults;0<f-10*c?a.children(".ainfo").empty().append('<a href="" onclick="$(this).closest(\'#atrack-'+d+"').productSearch("+d+", "+(c+1)+');return false;">[\u691c\u7d22\u7d50\u679c\u3042\u3068'+
...
g.append('<a href="'+decodeURIComponent(e)+'" title="'+c+'" target="_blank"><img src="'+f+'" class="widget-img-thumb" alt="'+c+'" /></a>')})}},a=e(this);a.children(".ainfo").empty().append('<img src="http://'+k+'/indi.gif" alt="\u5546\u54c1\u691c\u7d22\u4e2d..." width="10" height="10" /> \u5546\u54c1\u691c\u7d22\u4e2d...');e.ajax({url:"http://"+k+"/js/lastfm/amazon/request.php",data:{search_index:"Music",artist:p[d][0],title:p[d][1],item_page:c},dataType:"jsonp",callback:"callback",timeout:5E3}).done(function(b,
