...
l+'" title="'+g+" - "+f+'" target="_blank"><img src="'+c+'" class="widget-img-thumb" alt="'+g+" - "+f+'" onerror="this.src=(\'http://'+k+'/js/lastfm/noimag_lfm.gif\')" /></a><a href="'+l+'" title="'+g+" - "+f+'" target="_blank">'+(32<f.length?f.slice(0,32)+"...":f)+'</a><br /><a href="'+l+'" title="'+g+" - "+f+'" target="_blank">'+(32<g.length?g.slice(0,32)+"...":g)+'</a><div class="alist" style="clear:both;"></div><div class="ainfo" style="text-align:right;clear:both;opacity:0.2;"><a href="" onclick="$(this).closest(\'#atrack-'+
