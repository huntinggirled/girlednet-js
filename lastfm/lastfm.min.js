(function(e){var h=[],p=[],c,m=0,q,t=location.host.split(".").reverse(),k=t[1]+"."+t[0];e.fn.lastfm=function(d){c=e.extend({},{username:"huntinggirled",apikey:"1b5830677a2a62d47c10b6916034a4b0",interval:1E3,reload:6E5,limit:50,default_count:5,page_count:5,onComplete:function(){}},d);c.default_count>c.page_count&&(c.page_count=c.default_count);c.page_count>c.limit&&(c.limit=c.page_count);d=e(this);d.after('<div id="more_track" />');d.getRecentTracks()};e.fn.getRecentTracks=function(){var d={relativeTime:function(a){a=
(new Date).getTime()/1E3-a;return 60>a?'<img src="https://'+k+'/js/lastfm/eq.gif" alt="\u518d\u751f\u4e2d" width="12" height="12" /> \u518d\u751f\u4e2d':180>a?'<img src="https://'+k+'/js/lastfm/eq.gif" alt="\u518d\u751f\u4e2d" width="12" height="12" /> \u518d\u751f\u4e2d':3600>a?parseInt(a/60).toString()+"\u5206\u524d":86400>a?parseInt(a/3600).toString()+"\u6642\u9593\u524d":parseInt(a/86400).toString()+"\u65e5\u524d"},stripSlashes:function(a){return(a+"").replace(/\0/g,"0").replace(/\\([\\'"])/g,
"$1")},elapsedTime:function(a){return a.find(".ctime").each(function(){var b=e(this).html(),a=d.relativeTime(e(this).data("datetime"));b!=a&&e(this).css("opacity",0).html(a).fadeTo("normal",1)})},printContent:function(a,b){if(null==b)return!1;var c=null!=b.image&&null!=b.image[0]["#text"]&&""!=b.image[0]["#text"]?d.stripSlashes(b.image[0]["#text"]):"https://"+k+"/js/lastfm/noimg_lfm.gif",l=null!=d.stripSlashes(b.url)?d.stripSlashes(b.url):"https://"+k+"/",f=null!=b.name?b.name:"unknown title",g=null!=
b.artist&&null!=b.artist["#text"]?b.artist["#text"]:"unknown artist",h=null!=b.date&&null!=b.date.uts?d.relativeTime(b.date.uts):"",w=null!=b["@attr"]&&null!=b["@attr"].nowplaying?'<img src="https://'+k+'/js/lastfm/eq.gif" alt="\u518d\u751f\u4e2d" width="12" height="12" /> \u518d\u751f\u4e2d':"",x=null!=b.date&&null!=b.date.uts?b.date.uts:parseInt((new Date).getTime()/1E3),n=p.length;p[n]=[g,f];a.append('<div id="atrack-'+n+'" style="clear:both;"><div class="ctime" data-datetime="'+x+'">'+w+h+'</div><a href="'+
l+'" title="'+g+" - "+f+'" target="_blank"><img src="'+c+'" class="widget-img-thumb" alt="'+g+" - "+f+'" onerror="this.src=(\'https://'+k+'/js/lastfm/noimg_lfm.gif\')" /></a><a href="'+l+'" title="'+g+" - "+f+'" target="_blank">'+(32<f.length?f.slice(0,32)+"...":f)+'</a><br /><a href="'+l+'" title="'+g+" - "+f+'" target="_blank">'+(32<g.length?g.slice(0,32)+"...":g)+'</a><div class="alist" style="clear:both;"></div><div class="ainfo" style="text-align:right;clear:both;opacity:0.2;"><a href="" onclick="$(this).closest(\'#atrack-'+
...
eachThis:function(a){e("#more_track").empty().append('<div style="text-align:right;"><img src="https://'+k+'/js/lastfm/indi.gif" alt="\u8aad\u307f\u8fbc\u307f\u4e2d..." width="10" height="10" /> \u8aad\u307f\u8fbc\u307f\u4e2d...</div>');var b=m;if(1<=b&&h.length>=c.page_count){a.append('<div class="track" style="opacity:0.0;" />');var v=a.children(".track:last");d.shiftItems(v)}else return e.ajax({url:"https://ws.audioscrobbler.com/2.0/",data:{method:"user.getrecenttracks",user:c.username,api_key:c.apikey,
